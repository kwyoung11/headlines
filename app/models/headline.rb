class Headline < ActiveRecord::Base
  ...
  def self.scraper_options
  	scraper_options = {
  		...
  		:other_stories => {
  			:cnn => ".cnn_bulletbin li", :reuters => "h2:not(:first-child), h2", :chinadaily => "#main2 li, .headline-box h2, :nth-child(3) .wid300 h3", :bbc => "#top-story li, #second-story h2, #second_story li, 
